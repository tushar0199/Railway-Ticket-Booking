...
<html>
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-10" style="text-align: center; font-size: 100px; color:#2FFFFF"> Bengal Railway </div>
			<div class="col-md-10" style="text-align: center"> 
				
				<a href="../Controller/search_train.php" style = "font-size: 25px; color:#FFFFFF" >Booking Confirmation </a> 
...
if(isset($_POST['sid']) && isset($_POST['omg']) && isset($_POST['cls']) && isset($_POST['address']) && isset($_POST['pport']) && isset($_POST['iss']) && isset($_POST['exp']) && isset($_POST['ccn']))
{
	...
	if(mysqli_num_rows($result2))
	{
	  while($row = mysqli_fetch_array($result2))
	  {
		  ...
		  echo "Thank you for travelling with us. Have a safe journey. </br>";
	}
